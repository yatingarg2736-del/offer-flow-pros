...
const Footer = () => (
  <footer className="bg-primary py-14 text-primary-foreground">
    <div className="container grid gap-10 md:grid-cols-4">
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-extrabold">Deal<span className="text-accent">Mint</span></span>
        </div>
      ...
      <div>
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/70">
          <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-accent" /> partners@dealmint.co</li>
    ...
    <div className="container mt-10 border-t border-white/10 pt-6 text-center text-xs text-white/50">
      © {new Date().getFullYear()} DealMint Technologies Pvt Ltd. All rights reserved.
    </div>
  </footer>
);
